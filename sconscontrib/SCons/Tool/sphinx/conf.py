...
latex_documents = [
  ('index', 'sphinx-scons.tex', ur'sphinx-scons Documentation',
   ur'Glenn Hutchings', 'manual'),
]
...
texinfo_documents = [
  ('index', 'sphinx-scons', u'sphinx-scons Documentation',
   u'Glenn Hutchings', 'Sphinx-scons', 'Run Sphinx using SCons.',
   'Tools'),
]
